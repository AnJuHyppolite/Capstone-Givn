const facts = [
  ...
  },
  {
    ...
    facts: [
      ...
      "Paper accounts for 25 percent of waste in the landfill. About 68 million trees are cut down each year to produce paper and paper products. If you don't recycle the paper you use, it all ends up in the landfill.",
    ],
    source:
