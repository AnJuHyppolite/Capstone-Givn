...
const postRequest = async (newRequest) => {
    const { status, display_name, getter_id, giver_id, item_id } = newRequest
    ...
    return await db.oneOrNone('INSERT INTO requests(status, display_name, getter_id, giver_id, item_id) VALUES ($1, $2, $3, $4, $5) RETURNING *',
        [status, display_name, getter_id, giver_id, item_id]);
}
